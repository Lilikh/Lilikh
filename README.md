...
My name is Leila, and I am a detail-oriented software engineer with industry experience in building and maintaining websites and web applications, specializing in c#, TypeScript, JavaScript, and its frameworks in both server-side and client-side environments (Node.js, Express.js, React.js, Next.js, Vue.js)</p>
...
<!--
**Lilikh/Lilikh** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
